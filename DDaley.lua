-- =========================================================================
-- [[ DALEY UI SHELL ]] --
-- Paste this block first, then add your tabs and features below.
-- Available builders: CreateTab, Section, Label, Toggle, Slider,
...
-- Create tabs and add features using:
--
--   local MyTab = CreateTab("Tab Name")
--   Section(MyTab, "Section Name")
--   Toggle(MyTab, "Toggle Name", false, function(v) ... end)
--   Slider(MyTab, "Slider Name", min, max, default, increment, function(v) ... end)
--   Button(MyTab, "Button Name", function() ... end)
--   Label(MyTab, "Some info text")
--   TextBox(MyTab, "Placeholder text", function(text) ... end)
--   Dropdown(MyTab, "Label", {"Option1","Option2"}, function(sel) ... end)
--
-- Example:
--   local MovementTab = CreateTab("Movement")
--   Section(MovementTab, "Speed")
--   local speedEnabled = false
--   Toggle(MovementTab, "Speed Mode", false, function(v) speedEnabled = v end)
-- =========================================================================
